...
#define MAX_D 36
/**
@author Catalin Adelin Iovan i Cristian Asensio Dominguez
*/
...
void menu(void)
{
    ...
    printf("\n\n---------------------------------");
    printf("\n\nPulse 0 para traducir una palabra a morse ");
    printf("\n\nPulse 1 para traducir un fichero a morse ");
    printf("\n\nPulse 2 para traducir un fichero de morse a espanol  \n");
    printf("\n\nPara salir pulse cualquier otro numero\n");
...
Para crear esta estructura, primero leemos el fichero, despues hasta que no llegamos al final de fichero,
dividiremos la frase primero hasta que encuentra un espacio ( aqui seria nuestra letra/num), y despues hasta que encuentra
el caracter *(aqui seria la traduccion del morse)

Procederemos de esta manera hasta llegamos al final de fichero
*/
...
Si es una letra dejaremos 3 espacios, si es el final de una palabra, 5 espacios
...
A diferencia de la accion de arriba, procederemos a la inversa, esta vez comprobamos dentro del diccionario las traducciones a morse y cuando llegamos a algo parecido,
...
Tambien tenemos una comprobacion de que el tamaño del string introducido no sea superior a 15.
*/
...
Procedimiento parecido al de arriba, lo unico que en este caso tiene como entrada el fichero codificado y lo queremos descodificar.
